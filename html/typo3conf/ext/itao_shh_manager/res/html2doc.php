...
EOH;
		...
		{
			echo 'createDoc Entered.<br>this->docfile='.$this->docFile.'<br />';
			if(is_file($html))
		...
		function write_file($file,$content,$mode="w")		{			
			echo 'write_file entered!<br>file:'.$file.'<br />';
			#break;
			...
			$file = $abs_path.'/uploads/tx_itaoshhmanager/pdfs_wahlzettel/'.$file;
			#t3lib_utility_debug::debug($file);
			$fp=@fopen($file,$mode);
			if(!is_resource($fp)){
				echo "<br />am ende false";
				return false;
			}
			echo "<br />jetzt wird geschrieben";
			fwrite($fp,$content);
			fclose($fp);
			return true;
		}
