...
/**
 * Test case for class Tx_ItaoShhOffers_Domain_Model_StatusLog.
 *
 * @version $Id$
 ...
 */
class Tx_ItaoShhOffers_Domain_Model_StatusLogTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_ItaoShhOffers_Domain_Model_StatusLog
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_ItaoShhOffers_Domain_Model_StatusLog();
	}
