...
/**
 * Test case for class Tx_ItaoShhOffers_Domain_Model_Idea.
 *
 * @version $Id$
 ...
 */
class Tx_ItaoShhOffers_Domain_Model_IdeaTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_ItaoShhOffers_Domain_Model_Idea
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_ItaoShhOffers_Domain_Model_Idea();
	}
