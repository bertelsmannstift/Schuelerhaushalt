...
/**
 * Test case for class Tx_ItaoShhOffers_Domain_Model_OfferLog.
 *
 * @version $Id$
 ...
 */
class Tx_ItaoShhOffers_Domain_Model_OfferLogTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_ItaoShhOffers_Domain_Model_OfferLog
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_ItaoShhOffers_Domain_Model_OfferLog();
	}
