...
/**
 * Test case for class Tx_ItaoShhOffers_Domain_Model_LikeDislike.
 *
 * @version $Id$
 ...
 */
class Tx_ItaoShhOffers_Domain_Model_LikeDislikeTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_ItaoShhOffers_Domain_Model_LikeDislike
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_ItaoShhOffers_Domain_Model_LikeDislike();
	}
