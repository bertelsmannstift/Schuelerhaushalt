...
/**
 * Test case for class Tx_ItaoShhOffers_Domain_Model_Log.
 *
 * @version $Id$
 ...
 */
class Tx_ItaoShhOffers_Domain_Model_LogTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_ItaoShhOffers_Domain_Model_Log
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_ItaoShhOffers_Domain_Model_Log();
	}
