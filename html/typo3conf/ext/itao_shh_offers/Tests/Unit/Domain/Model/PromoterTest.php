...
/**
 * Test case for class Tx_ItaoShhOffers_Domain_Model_Promoter.
 *
 * @version $Id$
 ...
 */
class Tx_ItaoShhOffers_Domain_Model_PromoterTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
	 * @var Tx_ItaoShhOffers_Domain_Model_Promoter
	 */
	protected $fixture;

	public function setUp() {
		$this->fixture = new Tx_ItaoShhOffers_Domain_Model_Promoter();
	}
