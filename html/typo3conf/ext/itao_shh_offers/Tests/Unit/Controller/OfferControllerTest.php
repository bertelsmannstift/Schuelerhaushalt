...
/**
 * Test case for class Tx_Itao_shh_offers_Controller_OfferController.
 *
 * @version $Id$
 ...
 */
class Tx_Itao_shh_offers_Controller_OfferControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
