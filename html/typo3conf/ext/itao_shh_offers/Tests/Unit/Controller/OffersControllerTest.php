...
/**
 * Test case for class Tx_Itao_shh_offers_Controller_OffersController.
 *
 * @version $Id$
 ...
 */
class Tx_Itao_shh_offers_Controller_OffersControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
