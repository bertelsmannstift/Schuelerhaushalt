 ...
 *
 */
class Tx_ItaoShhOffers_Domain_Repository_DislikeRepository extends Tx_Extbase_Persistence_Repository {
	
	function findOfferSorting($feUserUid, $offerUid){
		echo $feUserUid . ' - ' . $offerUid;
		$query = $this->createQuery();
		$statement = "	SELECT DISTINCT * 
						FROM tx_itaoshhoffers_domain_model_dislike
	...
	function deleteFromTable($uid){
		mysql_query("DELETE FROM tx_itaoshhoffers_domain_model_dislike WHERE uid = " . $uid);
	}
}
?>