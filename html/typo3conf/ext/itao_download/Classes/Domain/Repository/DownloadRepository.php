...
/**
 * Repository for Tx_ItaoDownload_Domain_Model_Download
 */
class Tx_ItaoDownload_Domain_Repository_DownloadRepository extends Tx_Extbase_Persistence_Repository {
	...
	/**
	 * Gets downloads by the UID of their category.
	 * 
	 * @param string $category		The category for downloads.
	 * @return array
	 */
	public function findByCategoryUid($category) {
