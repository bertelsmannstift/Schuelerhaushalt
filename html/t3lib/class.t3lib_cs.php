...
class t3lib_cs {
	...
	function entities_to_utf8($str, $alsoStdHtmlEnt = FALSE) {
		...
		*/
		...
		/*
		# Auskommentiert von TGR am 19.10.2012 wegen Fehlermeldungen bei Suche:
		Warning: get_html_translation_table() expects at most 2 parameters, 3 given in /srv/www/web-856/html/t3lib/class.t3lib_cs.php on line 819
		Warning: array_flip() expects parameter 1 to be array, null given in /srv/www/web-856/html/t3lib/class.t3lib_cs.php on line 819		
		
		Und da ich zu doof bin, den Patch einzuspielen (http://forge.typo3.org/issues/39287), daher die manuelle Änderung. Sorry Leute.
		*/
